...
public class advance1L1asessterm extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance1_l1asessterm);
        ...
        correctAnswer = new Dialog(advance1L1asessterm.this);
        ...
        betterLuck = new Dialog(advance1L1asessterm.this);
        ...
        wrongAnswer = new Dialog(advance1L1asessterm.this);
        ...
        congratsDialog = new Dialog(advance1L1asessterm.this);
        ...
        Loading = new Dialog(advance1L1asessterm.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1HXsEbKyE2lwptTCcM61QHy8tyhjdy0KI"), //Angel
                Uri.parse("https://drive.google.com/uc?export=download&id=1oaAxW-yavEYW8ggdMuxZR2lRrhO0KWau"), //Bible
                Uri.parse("https://drive.google.com/uc?export=download&id=1xVg8kSLUQIxf_c25ApQJ3CtqJA8A0odc"), //Bless
                Uri.parse("https://drive.google.com/uc?export=download&id=1WJKo9sAXHAe11km1ISxktIzCf81ijeEV"), //Redeem
                Uri.parse("https://drive.google.com/uc?export=download&id=1sU5NePdkwi4-O3skG5hCTqgj-_WeK79h"), //Grace
                Uri.parse("https://drive.google.com/uc?export=download&id=1ZFDsfEI4_oqHCE3hin3DYyn9cfF8GmT9"), //Heaven
                Uri.parse("https://drive.google.com/uc?export=download&id=1xnmCRJUo0MbDpZ-gOBZe-U3_pysRFxF5"), //Hell
                Uri.parse("https://drive.google.com/uc?export=download&id=1k_yIKjPQJrLJNjgpgFaGZ2StzSfbEZ9l"), //Holy spirit
                Uri.parse("https://drive.google.com/uc?export=download&id=1VYF5NKfaE8vYVtnhBojuWPPDSnm0Wuli"), //Jesus son
                Uri.parse("https://drive.google.com/uc?export=download&id=1JhzX8NmwL5YVDdNZd9fAMbxlGYgtxMyj"), //Love
                Uri.parse("https://drive.google.com/uc?export=download&id=1HzdgsFYKcFjmqKnjKD36eRsaxVhs7YzC"), //Save
                // Add more URIs as needed
        };

        answers = new String[]{"Angel", "Bible", "Bless", "Redeem", "Grace", "Heaven", "Hell", "Holy spirit", "Jesus son",
                "Love","Save"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advance1L1asessterm.this, advance1L1biblicalterm.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("biblicalterm").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("biblicalterm");
                        DatabaseReference checknumberScore = usersRef.child("biblicaltermscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advance1L1asessterm.this, advancelevel1.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("biblicaltermscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("biblicaltermscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

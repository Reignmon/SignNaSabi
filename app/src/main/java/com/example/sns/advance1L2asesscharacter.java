...
public class advance1L2asesscharacter extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance1_l2asesscharacter);
        ...
        correctAnswer = new Dialog(advance1L2asesscharacter.this);
        ...
        betterLuck = new Dialog(advance1L2asesscharacter.this);
        ...
        wrongAnswer = new Dialog(advance1L2asesscharacter.this);
        ...
        congratsDialog = new Dialog(advance1L2asesscharacter.this);
        ...
        Loading = new Dialog(advance1L2asesscharacter.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1bXQScNkNJS4vnJReKrztl4dvlNELdGEL"), //Amas
                Uri.parse("https://drive.google.com/uc?export=download&id=1YtvHndorKAKmp9c33v-1rd0xA2mnNoaz"), //Bartholome
                Uri.parse("https://drive.google.com/uc?export=download&id=1MmYbJUcNiHxyu7N1Su1kcryHUIuYcp6n"), //David
                Uri.parse("https://drive.google.com/uc?export=download&id=1LDebJ50bs9HUtxQ6KgENcrugAej3Jcsj"), //Isaiah
                Uri.parse("https://drive.google.com/uc?export=download&id=1Xil-bXw_TcC7sTX4tJgbnHpQ87FS9lS-"), //Jacob
                Uri.parse("https://drive.google.com/uc?export=download&id=1mJ_Ydn38owwj9SuBQzcPjv_-Or_Ly_QH"), //Jeremiah
                Uri.parse("https://drive.google.com/uc?export=download&id=1qHICHAAQ8YqgSVQwg_8lAl6aws28aTYZ"), //Joshua
                Uri.parse("https://drive.google.com/uc?export=download&id=1fRGGdHQ-6YoYLb6v0P2ixf8K20eqex8E"), //Jude
                Uri.parse("https://drive.google.com/uc?export=download&id=1MT6aHX-oBmWzm9WrdUUcuzIoXxFMKc_1"), //Matthew
                Uri.parse("https://drive.google.com/uc?export=download&id=1l9gpx_yC5np6N8f4Z6gRWRD-UCBzX4Fb"), //Samuel
                // Add more URIs as needed
        };

        answers = new String[]{"Amas", "Bartholome", "David", "Isaiah", "Jacob", "Jeremiah", "Joshua", "Jude", "Matthew",
                "Samuel"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advance1L2asesscharacter.this, advance1L1biblicalcharac.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("biblicalcharacter").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("biblicalcharacter");
                        DatabaseReference checknumberScore = usersRef.child("biblicalcharacterscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advance1L2asesscharacter.this, advancelevel1.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("biblicalcharacterscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("biblicalcharacterscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

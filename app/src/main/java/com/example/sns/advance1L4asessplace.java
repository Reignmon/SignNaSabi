...
public class advance1L4asessplace extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance1_l4asessplace);
        ...
        correctAnswer = new Dialog(advance1L4asessplace.this);
        ...
        betterLuck = new Dialog(advance1L4asessplace.this);
        ...
        wrongAnswer = new Dialog(advance1L4asessplace.this);
        ...
        congratsDialog = new Dialog(advance1L4asessplace.this);
        ...
        Loading = new Dialog(advance1L4asessplace.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1hH_WVXl5wCgbp-WhSRVeKQ9XRq_Hf262"), //Babaylon
                Uri.parse("https://drive.google.com/uc?export=download&id=1bSQVgafOVFwJ435d4nzufzI0RTsiB86u"), //Calvary
                Uri.parse("https://drive.google.com/uc?export=download&id=17wJOBTMD7mAmbZJ7DcAwQwAdLlL5cKRy"), //Canaan
                Uri.parse("https://drive.google.com/uc?export=download&id=1orve4McWvs4n6DI1cMpkOiah5Gf_L3-8"), //Eden
                Uri.parse("https://drive.google.com/uc?export=download&id=19H8fUKPE4zmaRuWh719BtrJckZfzcGmf"), //Galilee
                Uri.parse("https://drive.google.com/uc?export=download&id=1GiPFNwBUOSFETg8tEvndvZg7wO7TzW2z"), //Gamorrah
                Uri.parse("https://drive.google.com/uc?export=download&id=1g5WbTbQr8D3nrW1IigtFfxRR8Pfh0JcY"), //Gaza
                Uri.parse("https://drive.google.com/uc?export=download&id=1D4pxhUW26UE13Q7qssbeZ4GQbEsgbICQ"), //Hevron
                Uri.parse("https://drive.google.com/uc?export=download&id=1MV_swSdCCJUXTwZyhar7LhIMK5bNArNa"), //Judah
                Uri.parse("https://drive.google.com/uc?export=download&id=1cAa9cdFs4By0D5Cty_8NCA398O0z3bdN"), //Nazareth
                Uri.parse("https://drive.google.com/uc?export=download&id=1JLQ5iFi04rvee9ZSqBJX6hxwBFRvMwgi"), //Samaria
                Uri.parse("https://drive.google.com/uc?export=download&id=1F6R5JTF9IV9ILHgJsNr-2uN2mMLq-kKX"), //Sinai
                // Add more URIs as needed
        };

        answers = new String[]{"Babaylon", "Calvary", "Canaan", "Eden", "Galilee", "Gamorrah", "Gaza", "Hevron", "Judah",
                "Nazareth","Samaria","Sinai"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advance1L4asessplace.this, advance1L4bibleplace.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("bibleplace").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("bibleplace");
                        DatabaseReference checknumberScore = usersRef.child("bibleplacescore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advance1L4asessplace.this, advancelevel1.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("bibleplacescore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("bibleplacescore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

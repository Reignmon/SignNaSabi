...
public class advance1L6asessSacrament extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance1_l6asess_sacrament);
        ...
        correctAnswer = new Dialog(advance1L6asessSacrament.this);
        ...
        betterLuck = new Dialog(advance1L6asessSacrament.this);
        ...
        wrongAnswer = new Dialog(advance1L6asessSacrament.this);
        ...
        congratsDialog = new Dialog(advance1L6asessSacrament.this);
        ...
        Loading = new Dialog(advance1L6asessSacrament.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1borQjsWp7GJlo7srdUajiwDoHjAjYun3"), //Annointing of the seek
                Uri.parse("https://drive.google.com/uc?export=download&id=1DydH4B2f522-j2gRMz0bq0e32mgIxNYI"), //Baptist
                Uri.parse("https://drive.google.com/uc?export=download&id=1EggLpMXldogd2wv3pqQKrqnS2npa0Dma"), //Confession
                Uri.parse("https://drive.google.com/uc?export=download&id=1oiWwYBLXPXqgLMa0_OscwUttNMoTmHLC"), //Confirmation
                Uri.parse("https://drive.google.com/uc?export=download&id=1zaLu6GD8_Jt-WwEFHhxNU8xj7cF75of0"), //Eucharist
                Uri.parse("https://drive.google.com/uc?export=download&id=1yQo1QmnIdte4zUmrkhZ15nnRkqdAJpsu"), //Holy orders
                Uri.parse("https://drive.google.com/uc?export=download&id=1BfWpeR6Dwz-vw0icVmS7J1GyQQMmO0xJ"), //Matrimony
                // Add more URIs as needed
        };

        answers = new String[]{"Annointing of the seek", "Baptist", "Confession", "Confirmation", "Eucharist", "Holy orders", "Matrimony"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advance1L6asessSacrament.this, advance1L6sacraments.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("sacraments").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("sacraments");
                        DatabaseReference checknumberScore = usersRef.child("sacramentsscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advance1L6asessSacrament.this, advancelevel1.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("sacramentsscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("sacramentsscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

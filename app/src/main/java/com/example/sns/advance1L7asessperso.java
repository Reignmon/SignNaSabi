...
public class advance1L7asessperso extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance1_l7asessperso);
        ...
        correctAnswer = new Dialog(advance1L7asessperso.this);
        ...
        betterLuck = new Dialog(advance1L7asessperso.this);
        ...
        wrongAnswer = new Dialog(advance1L7asessperso.this);
        ...
        congratsDialog = new Dialog(advance1L7asessperso.this);
        ...
        Loading = new Dialog(advance1L7asessperso.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1nYoexMTxDj2NO15mK8OkLLry7nzr7XAK"), //Accountant
                Uri.parse("https://drive.google.com/uc?export=download&id=1DeoMCLN-fi4sYYMv3mTE3QaoIdXBeSYg"), //Chaplain
                Uri.parse("https://drive.google.com/uc?export=download&id=1-XHcvjKvbJkctWdLimVPAdnRYLNAIp8t"), //Church Secretary
                Uri.parse("https://drive.google.com/uc?export=download&id=1PqRuiBFu5PiKKgI_mxk4VTaEx1ctvRJn"), //Custodian
                Uri.parse("https://drive.google.com/uc?export=download&id=1m801EbFBdDqUM92l8Auytf6rBZ97OPSZ"), //Music editor
                Uri.parse("https://drive.google.com/uc?export=download&id=1IASoz0o_O8t4Dg7nHgHsHs8-mzxWAVPX"), //Office manager
                Uri.parse("https://drive.google.com/uc?export=download&id=17JAQbP2rZYl8HweRINHZ3KTkJiJIpCHT"), //Pastor
                Uri.parse("https://drive.google.com/uc?export=download&id=1NbvgBcXuMNVzmHvWfWz5q9Zl7bex-XqX"), //Receptionist
                Uri.parse("https://drive.google.com/uc?export=download&id=1FLLjmHl7jnlojg9drKoHdbLPXUWTDCE8"), //Worship leader
                Uri.parse("https://drive.google.com/uc?export=download&id=1Db0q6BkZ_LidzBth2yL1s2nwjkSTFXUT"), //Youth pastor
                // Add more URIs as needed
        };

        answers = new String[]{"Accountant", "Chaplain", "Church Secretary", "Custodian", "Music editor", "Office manager", "Pastor", "Receptionist", "Worship leader",
                "Youth pastor"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advance1L7asessperso.this, advance1L7personel.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("churchpersonel").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("churchpersonel");
                        DatabaseReference checknumberScore = usersRef.child("churchpersonelscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advance1L7asessperso.this, advancelevel1.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("churchpersonelscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("churchpersonelscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

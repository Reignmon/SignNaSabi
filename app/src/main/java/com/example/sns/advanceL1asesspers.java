...
public class advanceL1asesspers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_l1asesspers);
        ...
        correctAnswer = new Dialog(advanceL1asesspers.this);
        ...
        betterLuck = new Dialog(advanceL1asesspers.this);
        ...
        wrongAnswer = new Dialog(advanceL1asesspers.this);
        ...
        congratsDialog = new Dialog(advanceL1asesspers.this);
        ...
        Loading = new Dialog(advanceL1asesspers.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1FVfF6_vCuLYcX4zei4k-iehRxosMfqfe"), //cafeteria
                Uri.parse("https://drive.google.com/uc?export=download&id=1FVfF6_vCuLYcX4zei4k-iehRxosMfqfe"), //guard
                Uri.parse("https://drive.google.com/uc?export=download&id=1ym0OYU_-FaIGTGa3I3CDFVi-b7iT4zy9"), //gym
                Uri.parse("https://drive.google.com/uc?export=download&id=15Dp3WPVOqxhDb2zftXjhM3FhJeaXE0sS"), //library
                Uri.parse("https://drive.google.com/uc?export=download&id=1cfIg76hmRBpwCsECc6vxjm9yYC1RNHhf"), //nurse
                Uri.parse("https://drive.google.com/uc?export=download&id=1fsK5s2wPQsqLKr91M8f2EHSNGjY_UdRC"), //office
                Uri.parse("https://drive.google.com/uc?export=download&id=1L8SpVxhbWHl7YM3cyA_mwne86DIrfxaN"), //principal
                Uri.parse("https://drive.google.com/uc?export=download&id=1rR7epydm9hrEwZprS6RyRR-fRew6nnEm"), //student
                Uri.parse("https://drive.google.com/uc?export=download&id=1JRUCBr7_II6DoStT8XqH3Pzl48Gc9rRs"), //studentcenter
                Uri.parse("https://drive.google.com/uc?export=download&id=1aRMmwt-cST1SXXmMnLgBoDTzum_FsU0F"), //teacher
                // Add more URIs as needed
        };

        answers = new String[]{"Cafeteria", "Guard", "Gym", "Library", "Nurse", "Office", "Principal", "Student", "Student Center",
                "Teacher"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advanceL1asesspers.this, advanceL1personel.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("personel").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("personel");
                        DatabaseReference checknumberScore = usersRef.child("personelscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL1asesspers.this, advancelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("personelscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("personelscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

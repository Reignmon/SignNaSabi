...
public class advanceL1asesssub extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_l1asesssub);
        ...
        correctAnswer = new Dialog(advanceL1asesssub.this);
        ...
        betterLuck = new Dialog(advanceL1asesssub.this);
        ...
        wrongAnswer = new Dialog(advanceL1asesssub.this);
        ...
        congratsDialog = new Dialog(advanceL1asesssub.this);
        ...
        Loading = new Dialog(advanceL1asesssub.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1E0HGyKJc4QgLbrmdS75XC9YjFSG7DyOM"), //art
                Uri.parse("https://drive.google.com/uc?export=download&id=1w-caJ0TyBxDIwyXbbC3WI8Fl0RtP51JY"), //english
                Uri.parse("https://drive.google.com/uc?export=download&id=1vqhjvEi53Q-HH9QbjqDZKobyozcEi68N"), //ethics
                Uri.parse("https://drive.google.com/uc?export=download&id=15qzvmsiQ_1N5HwOnZ-AGJAdTpSb_om-s"), //history
                Uri.parse("https://drive.google.com/uc?export=download&id=12pU4YlXCgX9eaxawbptEzYzq84Jllan8"), //math
                Uri.parse("https://drive.google.com/uc?export=download&id=1_Jp2G8ncW7ZbWxW1p_mK2I-jCbAq90iu"), //music
                Uri.parse("https://drive.google.com/uc?export=download&id=1ysqZjkAOmmWQISIM4YHNZojD9Az61bIs"), //science
                // Add more URIs as needed
        };

        answers = new String[]{"Art", "English", "Ethics", "History", "Math", "Music", "Science"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advanceL1asesssub.this, advanceL1subject.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("subjectscore").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("subject");
                        DatabaseReference checknumberScore = usersRef.child("subjectscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL1asesssub.this, advancelevel.class));
                                    finish();
                                }else{
        ...
        usersRef.child("subjectscore").addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("subjectscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

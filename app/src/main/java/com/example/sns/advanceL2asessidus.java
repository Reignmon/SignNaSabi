...
public class advanceL2asessidus extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_l2asessidus);
        ...
        correctAnswer = new Dialog(advanceL2asessidus.this);
        ...
        betterLuck = new Dialog(advanceL2asessidus.this);
        ...
        wrongAnswer = new Dialog(advanceL2asessidus.this);
        ...
        congratsDialog = new Dialog(advanceL2asessidus.this);
        ...
        Loading = new Dialog(advanceL2asessidus.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1cvYENh6PzUnoKH1TpjadCmbChaDwnJyj"), //7-11
                Uri.parse("https://drive.google.com/uc?export=download&id=1ImhTCvncUvw9hrTxP7G0mcENhARqJe51"), //apple
                Uri.parse("https://drive.google.com/uc?export=download&id=1ImhTCvncUvw9hrTxP7G0mcENhARqJe51"), //burger king
                Uri.parse("https://drive.google.com/uc?export=download&id=1ngAI65adLsuNQFIh7--YzLTqnoKVAUqu"), //coke
                Uri.parse("https://drive.google.com/uc?export=download&id=16LJ-LO-PTK1pLSrmcDhjeDZ6LjfBqUjX"), //dunk in donuts
                Uri.parse("https://drive.google.com/uc?export=download&id=1iCjhkFTdwPElxXQmJkFIc1t958-rVoOx"), //google
                Uri.parse("https://drive.google.com/uc?export=download&id=118qgoov_ua7aefGyBxAjwFlL1P1gVR9C"), //mcdonalds
                Uri.parse("https://drive.google.com/uc?export=download&id=1FoQugq-AbiO6Y90GmfktlXd4XZEh5NGQ"), //nike
                Uri.parse("https://drive.google.com/uc?export=download&id=1PXnLfhp_k4XRFZAjgE8NFPaqYNDIWX2Q"), //pepsi
                Uri.parse("https://drive.google.com/uc?export=download&id=1jIQs-jCIH9vnwNf407Wt_mc-nyOBBtAh"), //youtube
                // Add more URIs as needed
        };

        answers = new String[]{"7 eleven", "Apple", "Burger King", "Coke", "Dunkin Donuts", "Google", "McDonald's", "Nike", "Pepsi",
                "Youtube"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advanceL2asessidus.this, advanceL2industries.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("industries").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("industries");
                        DatabaseReference checknumberScore = usersRef.child("industriesscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL2asessidus.this, advancelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("industriesscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("industriesscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

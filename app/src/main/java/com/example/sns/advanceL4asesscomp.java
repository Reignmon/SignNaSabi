...
public class advanceL4asesscomp extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_l4asesscomp);
        ...
        correctAnswer = new Dialog(advanceL4asesscomp.this);
        ...
        betterLuck = new Dialog(advanceL4asesscomp.this);
        ...
        wrongAnswer = new Dialog(advanceL4asesscomp.this);
        ...
        congratsDialog = new Dialog(advanceL4asesscomp.this);
        ...
        Loading = new Dialog(advanceL4asesscomp.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1VVtmo5nn6C2oqZPnOp2Cm8qrCW6axBnP"), //CPU
                Uri.parse("https://drive.google.com/uc?export=download&id=1gjfyxvFfVyBEPO6SGdfUtlWZVe-lsj-2"), //headphone
                Uri.parse("https://drive.google.com/uc?export=download&id=10Gdg6jQVnrx62V5k69t1Sa7Sbvq8Fi1n"), //keyboard
                Uri.parse("https://drive.google.com/uc?export=download&id=1HTLlSrquBZvLyl2klaW-8RLRpp2zeQyO"), //memory
                Uri.parse("https://drive.google.com/uc?export=download&id=19w-XnIX1Ks39o-iSrgq_N0kGtCNWOAxP"), //monitor
                Uri.parse("https://drive.google.com/uc?export=download&id=1SadDjjIuyHX53aXoaeoCmL0QvAnMVh8a"), //mouse
                Uri.parse("https://drive.google.com/uc?export=download&id=1jRbbC1eUEpFfIX7UFElyyxnJm3mnEiDo"), //printer
                Uri.parse("https://drive.google.com/uc?export=download&id=14tuu18Y8rxNwtQ2-Q375G5o48wibv5_N"), //router
                Uri.parse("https://drive.google.com/uc?export=download&id=1VOtIL9QxDSLmHuKSMmcunVz8pgL_5liQ"), //storage
                Uri.parse("https://drive.google.com/uc?export=download&id=1vqD2wejzArp7eudMN2AmP43AsfbDR84z"), //systemunit
                // Add more URIs as needed
        };

        answers = new String[]{"CPU", "Headphone", "Keyboard", "Memory", "Monitor", "Mouse", "Printer", "Router", "Storage",
                "System unit"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advanceL4asesscomp.this, advanceL4computer.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("computer").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("computer");
                        DatabaseReference checknumberScore = usersRef.child("computerscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL4asesscomp.this, advancelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("computerscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("computerscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

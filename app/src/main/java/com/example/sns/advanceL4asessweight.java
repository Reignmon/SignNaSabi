...
public class advanceL4asessweight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_l4asessweight);
        ...
        correctAnswer = new Dialog(advanceL4asessweight.this);
        ...
        betterLuck = new Dialog(advanceL4asessweight.this);
        ...
        wrongAnswer = new Dialog(advanceL4asessweight.this);
        ...
        congratsDialog = new Dialog(advanceL4asessweight.this);
        ...
        Loading = new Dialog(advanceL4asessweight.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1iosmy-lEs2MA7WiAKuKudEAG2l6NChzJ"), //centimeter
                Uri.parse("https://drive.google.com/uc?export=download&id=1VnNXdgfqZHd_1-pw46vHhpadr5iIwVWT"), //degree
                Uri.parse("https://drive.google.com/uc?export=download&id=1dHPB2pRcsE8sYf-6vYeRCnXbybtu5Wss"), //gallon
                Uri.parse("https://drive.google.com/uc?export=download&id=1hzmImM2J2WgfkkFrVHOVBH3wENdwZuAj"), //inch
                Uri.parse("https://drive.google.com/uc?export=download&id=1M2p_z9cN6QmXCwURaD3nJxIdGOTQVTDP"), //liter
                Uri.parse("https://drive.google.com/uc?export=download&id=10UK0Kfs26Z7XxWCc7rpYVMoFI_PaRzHQ"), //meter
                Uri.parse("https://drive.google.com/uc?export=download&id=1us469jyxSvQjcAY6AL4TAIrHv9ybTesd"), //mile
                Uri.parse("https://drive.google.com/uc?export=download&id=1lYnHXsvnfmA0opbB8zwUliFVGSi5hj91"), //milimeter
                Uri.parse("https://drive.google.com/uc?export=download&id=18dOfgSX7hbGMrr-JOYhZwiiY-pWv3YuE"), //mph
                Uri.parse("https://drive.google.com/uc?export=download&id=1hSv2cWG3S4iTZogNF3N9lGUJ7fqYstd0"), //ounce
                Uri.parse("https://drive.google.com/uc?export=download&id=1UFOKzoynncSu9sDmnAY1v_LrvoBBAtnx"), //square
                Uri.parse("https://drive.google.com/uc?export=download&id=1gap_bVetlP2EPGmjB5YQgB0g-IZbvni8"), //yard
                // Add more URIs as needed
        };

        answers = new String[]{"Centimeter", "Degree", "Gallon", "Inch", "Liter", "Meter", "Mile", "Milimeter", "Mph",
                "Ounce","Square","Yard"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advanceL4asessweight.this, advanceL3measure.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("measure").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("measure");
                        DatabaseReference checknumberScore = usersRef.child("measurescore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL4asessweight.this, advancelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("measurescore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("measurescore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

...
public class advanceL5asesssports extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_l5asesssports);
        ...
        correctAnswer = new Dialog(advanceL5asesssports.this);
        ...
        betterLuck = new Dialog(advanceL5asesssports.this);
        ...
        wrongAnswer = new Dialog(advanceL5asesssports.this);
        ...
        congratsDialog = new Dialog(advanceL5asesssports.this);
        ...
        Loading = new Dialog(advanceL5asesssports.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1QGYeWIX9OKonYDkpalzFl1APHySs-unM"), //baseball
                Uri.parse("https://drive.google.com/uc?export=download&id=1gn_nymwUaNWd2LIuk0BuyVPT4aciiAUa"), //basketball
                Uri.parse("https://drive.google.com/uc?export=download&id=1zrMAxf9DNo74g22YUve2Xkrr3YuAgbrv"), //boxing
                Uri.parse("https://drive.google.com/uc?export=download&id=1pmodCcwP3Ajn5BUergQKfNK1x3Oj7Fut"), //golf
                Uri.parse("https://drive.google.com/uc?export=download&id=1F-S-lNc5jiTDHEbgY-Wut8PY3rLVREqT"), //jog
                Uri.parse("https://drive.google.com/uc?export=download&id=1JcoLxqKeGShylYbD2hxFzsInGcOpvTDs"), //play
                Uri.parse("https://drive.google.com/uc?export=download&id=1v2C0m2ryEnBO9GmFJj5JbqVJwEiWwO5P"), //run
                Uri.parse("https://drive.google.com/uc?export=download&id=1GqUOaQ-EdqF4V_ytLMRO__npAaQWLCPH"), //soccer
                Uri.parse("https://drive.google.com/uc?export=download&id=1YSPUQobppOcEAK8y_MCNBwT5UnA0HXeM"), //tennis
                Uri.parse("https://drive.google.com/uc?export=download&id=1zq6FL-uJPSaYqTPijwADryIlSnLFyr0C"), //volleyball
                // Add more URIs as needed
        };

        answers = new String[]{"Baseball", "Basketball", "Boxing", "Golf", "Jog", "Play", "Run", "Soccer", "Tennis",
                "Volleyball"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advanceL5asesssports.this, advanceL5sports.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("sports").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("sports");
                        DatabaseReference checknumberScore = usersRef.child("sportsscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL5asesssports.this, advancelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("sportsscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("sportsscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

...
public class advanceL6asesscountry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_l6asesscountry);
        ...
        correctAnswer = new Dialog(advanceL6asesscountry.this);
        ...
        betterLuck = new Dialog(advanceL6asesscountry.this);
        ...
        wrongAnswer = new Dialog(advanceL6asesscountry.this);
        ...
        congratsDialog = new Dialog(advanceL6asesscountry.this);
        ...
        Loading = new Dialog(advanceL6asesscountry.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=15I5tvoorMTmdwkznvHJIIBaLgJcpoo7I"), //America
                Uri.parse("https://drive.google.com/uc?export=download&id=1SsyUbYSAM-H2rfaqmsQqS-_BODtlqM5I"), //Australia
                Uri.parse("https://drive.google.com/uc?export=download&id=19Ztmcb3L8YzdDdRBUESyQrgyCC2kVlkD"), //Canada
                Uri.parse("https://drive.google.com/uc?export=download&id=1WimUwF4ravwWtxm1b34CSMnSqc2TDQWn"), //China
                Uri.parse("https://drive.google.com/uc?export=download&id=1NM9meui5xoQTjFhBoemZPpYdkOHNFJx3"), //France
                Uri.parse("https://drive.google.com/uc?export=download&id=1IY7tgdrBysDQyUQt8ckXtzHiRtpnnULX"), //Germany
                Uri.parse("https://drive.google.com/uc?export=download&id=1I1vXkko6YM-MpdpfaRHOqooYmh8LkxVz"), //Israel
                Uri.parse("https://drive.google.com/uc?export=download&id=1A0IE9lhKAvqqHxmvQXFpyOsds_UnoMj_"), //Japan
                Uri.parse("https://drive.google.com/uc?export=download&id=1FPmKzsF9SQfjRf1xZZZ9_oE-5arNtAHs"), //Korea
                Uri.parse("https://drive.google.com/uc?export=download&id=1IYGy7yg8YgTtMiTLxjMYuWuU91iLyDRf"), //Philippines
                // Add more URIs as needed
        };

        answers = new String[]{"America", "Australia", "Canada", "China", "France", "Germany", "Israel", "Japan", "Korea",
                "Philippines"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advanceL6asesscountry.this, advanceL6asesscountry.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("countries").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("countries");
                        DatabaseReference checknumberScore = usersRef.child("countriesscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL6asesscountry.this, advancelevel.class));
                                    finish();
                                }else{
                                    lessonaslRef.setValue(0);
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL6asesscountry.this, advanceL6countries.class));
                                    finish();
                                }
                            }
                            @Override
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("countriesscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("countriesscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

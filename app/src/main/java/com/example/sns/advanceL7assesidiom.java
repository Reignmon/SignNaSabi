...
public class advanceL7assesidiom extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_advance_l7assesidiom);
        ...
        correctAnswer = new Dialog(advanceL7assesidiom.this);
        ...
        betterLuck = new Dialog(advanceL7assesidiom.this);
        ...
        wrongAnswer = new Dialog(advanceL7assesidiom.this);
        ...
        congratsDialog = new Dialog(advanceL7assesidiom.this);
        ...
        Loading = new Dialog(advanceL7assesidiom.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1kcMx2VEnuc4a5oIehi1iGYPeIV4GD-6K"), //Common sense
                Uri.parse("https://drive.google.com/uc?export=download&id=1bAqxTxeDrsGLFpDmP5240vMy-N5eyoSC"), //Darn you
                Uri.parse("https://drive.google.com/uc?export=download&id=1D1tqu0_faHHP8NsYcvIG5PIAFlqyOHiM"), //Expert
                Uri.parse("https://drive.google.com/uc?export=download&id=1y9rE_kiIEIqCAtYeor4IbHVrNgodfimE"), //Fallback
                Uri.parse("https://drive.google.com/uc?export=download&id=1_bIQUCHin_2Z5W4VLD6VFOKaC1bT9--g"), //Hit the jackpot
                Uri.parse("https://drive.google.com/uc?export=download&id=1mU8CZKnvP_5yGapEoHaB4dABX54LeTjj"), //Jump for joy
                Uri.parse("https://drive.google.com/uc?export=download&id=1nRgDiE40C9Df8eUx2W5i79UBGTBifigf"), //Keep an eye on
                Uri.parse("https://drive.google.com/uc?export=download&id=1AbY57Q1pRM8InQIaJCw-EdkMYS2z2muH"), //Messed up
                Uri.parse("https://drive.google.com/uc?export=download&id=1RdA73t5Dc-8LnvLMV7QnVeauhJlB62PM"), //Overlook
                Uri.parse("https://drive.google.com/uc?export=download&id=1TW5RcBfdj1rkENVIzyRoXvNan-ffJhbH"), //That's understandable
                Uri.parse("https://drive.google.com/uc?export=download&id=15MZzx2IRQqZ9g2cRgmbQZzregj85PEWy"), //Totally
                // Add more URIs as needed
        };

        answers = new String[]{"Common sense", "Darn you", "Expert", "Fallback", "Hit the jackpot", "Jump for joy", "Keep an eye on", "Messed up"
                , "Overlook", "That's understandable", "Totally"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(advanceL7assesidiom.this, advanceL7idiom.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("idiom").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("idiom");
                        DatabaseReference checknumberScore = usersRef.child("idiomscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(advanceL7assesidiom.this, advancelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("idiomscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("idiomscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

...
public class b5actionword extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Loading = new Dialog(b5actionword.this);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (lesson1 == 18) {
                        ...
                        DatabaseReference getscore = usersRef.child("actionwordscore");
                                            ...
                                            sign.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    if (snapshot.exists()){
                                                        ...
                                                        sign.setValue(12);
                                                        Loading.dismiss();
                                                        startActivity(new Intent(b5actionword.this, basicL5asessaction.class));
                                                        finish();
                                                    }
                                                }
                                                @Override

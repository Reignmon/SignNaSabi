...
public class b8bodypart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_b8bodypart);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(b8bodypart.this,basiclevel.class));
                finish();
            }
        });
...
//end of code for backpress
            ...
            databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.hasChild(encodedEmail)){
                        usersRef.child("bodyparts").setValue(currentIndex);
                    }
                }
                @Override
    ...
    private void retrieveCurrentIndexFromFirebase() {
        String encodedEmail = encodeEmail(name);
        DatabaseReference usersRef = databaseReference.child("BasicLevel_tb").child(encodedEmail).child("bodyparts");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (lesson1 == 13)  {
                        ...
                        DatabaseReference getscore = usersRef.child("bodypartsscore");
                                            ...
                                            sign.addListenerForSingleValueEvent(new ValueEventListener() {
                                                ...
                                                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                                    if (snapshot.exists()){
                                                        ...
                                                        sign.setValue(20);
                                                        Loading.dismiss();
                                                        startActivity(new Intent(b8bodypart.this, basicL8asessbodypart.class));
                                                        finish();
                                                    }
                                                }
                                                @Override

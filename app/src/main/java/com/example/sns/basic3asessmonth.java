...
public class basic3asessmonth extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic3asessmonth);
        ...
        correctAnswer = new Dialog(basic3asessmonth.this);
        ...
        betterLuck = new Dialog(basic3asessmonth.this);
        ...
        wrongAnswer = new Dialog(basic3asessmonth.this);
        ...
        congratsDialog = new Dialog(basic3asessmonth.this);
        ...
        Loading = new Dialog(basic3asessmonth.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1vRqRHsqrztsBe3qSW0HSRysdvFoevW2D"), //april
                Uri.parse("https://drive.google.com/uc?export=download&id=1M0o-ACUPfDkntgz7Ousiur_OyzDyKp1R"), //august
                Uri.parse("https://drive.google.com/uc?export=download&id=1pYjzi7wimow1J1fmg1QncB4n208Do2QJ"), //december
                Uri.parse("https://drive.google.com/uc?export=download&id=1jy2HAupxHhC8egghlclbodvs49c5nRby"), //february
                Uri.parse("https://drive.google.com/uc?export=download&id=1MdzpEMs05Hr3A_DPPGoVavvj6nLIUT79"), //january
                Uri.parse("https://drive.google.com/uc?export=download&id=1KiZ0UUR-Q5mzi6NlW44I4rQISeC68RKG"), //july
                Uri.parse("https://drive.google.com/uc?export=download&id=1QK3KhOKFLxevNmjb4uT7PCT_aOpX7Txe"), //june
                Uri.parse("https://drive.google.com/uc?export=download&id=1EyLe8tYxihmcqgeOxhB-6FuDmGa4yxxn"), //march
                Uri.parse("https://drive.google.com/uc?export=download&id=1zcnQrhMVsNqDkKNJiPYl5qCbpmSVQNVK"), //may
                Uri.parse("https://drive.google.com/uc?export=download&id=1gR6JcB5JCTuLk3I9KdsZ9dkmRBzqWCBb"), //november
                Uri.parse("https://drive.google.com/uc?export=download&id=1kH_NXOaDcykXQPegaaJjlOHKFFQRs6j6"), //october
                Uri.parse("https://drive.google.com/uc?export=download&id=1sXpucat7qPsf7SUR0GXjvRxe7_zzrY8M"), //september
                // Add more URIs as needed
        };

        answers = new String[]{"April", "August", "December", "February", "January", "July",
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basic3asessmonth.this, b3mothoftheyear.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("month").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("month");
                        DatabaseReference checknumberScore = usersRef.child("monthscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basic3asessmonth.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("monthscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("monthscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

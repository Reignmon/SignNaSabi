...
public class basicL2asessgreetings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l2asessgreetings);
        ...
        correctAnswer = new Dialog(basicL2asessgreetings.this);
        ...
        betterLuck = new Dialog(basicL2asessgreetings.this);
        ...
        wrongAnswer = new Dialog(basicL2asessgreetings.this);
        ...
        congratsDialog = new Dialog(basicL2asessgreetings.this);
        ...
        Loading = new Dialog(basicL2asessgreetings.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1WfZEbtNUNAun5ZnpSWIMoc4xUNbPe_Pq"), //good afternoon
                Uri.parse("https://drive.google.com/uc?export=download&id=1_u8AnjsdEgLhY12nD9h7niqRk9qKM4Id"), //good morning
                Uri.parse("https://drive.google.com/uc?export=download&id=179HRhEAEwnlPAozzXpoWLFkLYwRKKlan"), //good night
                Uri.parse("https://drive.google.com/uc?export=download&id=13nfCxQSPvje-JzbmuGlZGX0aH8GoMjRG"), //how are you
                Uri.parse("https://drive.google.com/uc?export=download&id=1xzgtaHlTq_UEUd8QIqN8MFy0RBInLM7f"), //how have you been
                Uri.parse("https://drive.google.com/uc?export=download&id=12OI4VfmhJtI98s4oDVstQNm24K5tP623"), //im glad to see you
                Uri.parse("https://drive.google.com/uc?export=download&id=1CKkGk2nN3O4iCyS1RC7HXYynYqK-L09U"), //im sorry
                Uri.parse("https://drive.google.com/uc?export=download&id=1eTTRPGl-x0M7nfhJV_QPeawmChrq2MjC"), //open door
                Uri.parse("https://drive.google.com/uc?export=download&id=1pV4Q_vKyNISg_dOfu0V3BVop1dR1PJuv"), //please
                Uri.parse("https://drive.google.com/uc?export=download&id=1pzdK8WQY5U-1KwT14LxPBqQbj2kpzM3a"), //wheres the bathroom
                // Add more URIs as needed
        };

        answers = new String[]{"Good afternoon", "Good morning", "Good night", "How are you", "How have you been", "Im glad to see you",
                "Im sorry", "Open door", "Please", "Wheres the bathroom"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL2asessgreetings.this, b2greetings.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("greetings").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("greetings");
                        DatabaseReference checknumberScore = usersRef.child("greetingsscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL2asessgreetings.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("greetingsscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("greetingsscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

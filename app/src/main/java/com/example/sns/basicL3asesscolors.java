...
public class basicL3asesscolors extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l3asesscolors);
        ...
        correctAnswer = new Dialog(basicL3asesscolors.this);
        ...
        betterLuck = new Dialog(basicL3asesscolors.this);
        ...
        wrongAnswer = new Dialog(basicL3asesscolors.this);
        ...
        congratsDialog = new Dialog(basicL3asesscolors.this);
        ...
        Loading = new Dialog(basicL3asesscolors.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1SW8UoxjlNQ3etMKM8fVNugu3dDfLamMC"), //black
                Uri.parse("https://drive.google.com/uc?export=download&id=1fqIo92YSoCl0Wy-vlM-E63FnGKGz9T2C"), //blue
                Uri.parse("https://drive.google.com/uc?export=download&id=1D9zLfr7BHs6D2Ehf_EE7MrBjAG1384CT"), //brown
                Uri.parse("https://drive.google.com/uc?export=download&id=1knlBbc8Kz9rsY1lV7ZMmwtaVVjU_SVFT"), //gold
                Uri.parse("https://drive.google.com/uc?export=download&id=1IJjfKErNpxXiZGKhQphj2_0l9qhzANa_"), //gray
                Uri.parse("https://drive.google.com/uc?export=download&id=1EbMseBpCXojP1zYaptDWgzx2Efxn1A7B"), //green
                Uri.parse("https://drive.google.com/uc?export=download&id=1wncOK7moYYkduYaQuqAiKw-B_roBrOs-"), //orange
                Uri.parse("https://drive.google.com/uc?export=download&id=1sh7fj_3VvPVEUMpPxCpnykzvctTl45c-"), //pink
                Uri.parse("https://drive.google.com/uc?export=download&id=1sh7fj_3VvPVEUMpPxCpnykzvctTl45c-"), //purple
                Uri.parse("https://drive.google.com/uc?export=download&id=1YGGBWxCiuMQSBfjWOhjuVkEnthYBGCuz"), //red
                // Add more URIs as needed
        };

        answers = new String[]{"Black", "Blue", "Brown", "Gold", "Gray", "Green",
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL3asesscolors.this, b3colors.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("colors").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("colors");
                        DatabaseReference checknumberScore = usersRef.child("colorsscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL3asesscolors.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("colorsscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("colorsscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

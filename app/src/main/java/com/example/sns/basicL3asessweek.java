...
public class basicL3asessweek extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l3asessweek);
        ...
        correctAnswer = new Dialog(basicL3asessweek.this);
        ...
        betterLuck = new Dialog(basicL3asessweek.this);
        ...
        wrongAnswer = new Dialog(basicL3asessweek.this);
        ...
        congratsDialog = new Dialog(basicL3asessweek.this);
        congratsDialog.setContentView(R.layout.completevideo);
        ...
        Loading = new Dialog(basicL3asessweek.this);
        ...
        //https://drive.google.com/file/d/1Jcu76ygUSZsN7WLKurl-5uj3okxzN-19/view?usp=sharing
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1Gq4rPOYVOZhh9FcoLSJbIUS88v94b_MS"), //monday
                Uri.parse("https://drive.google.com/uc?export=download&id=1p16S5esvarrCXxpNf2DtGEij6tCTFkj1"), //tuesday
                Uri.parse("https://drive.google.com/uc?export=download&id=1ZHsbWQ85jy2ESWbKf_wLKNwoPa3VMSnn"), //wednesday
                Uri.parse("https://drive.google.com/uc?export=download&id=190q19ex4i2ehNlK-gAf9ut141IGR2v3F"), //thursday
                Uri.parse("https://drive.google.com/uc?export=download&id=1LRAY-vtR4mwTeF8Xw7Fa15RZ_BKzdRmI"), //friday
                Uri.parse("https://drive.google.com/uc?export=download&id=19nu1KtZtw762EwmCH6fuLSbqgy6_i4Pj"), //saturday
                Uri.parse("https://drive.google.com/uc?export=download&id=1Jcu76ygUSZsN7WLKurl-5uj3okxzN-19"), //sunday
                // Add more URIs as needed
        };

        answers = new String[]{"Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday",
                "Sunday"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL3asessweek.this, b3daysofweek.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("daysofweek").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("daysofweek");
                        DatabaseReference checknumberScore = usersRef.child("daysofweekscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL3asessweek.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("daysofweekscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("daysofweekscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

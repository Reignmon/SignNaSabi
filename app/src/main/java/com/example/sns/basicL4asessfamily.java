...
public class basicL4asessfamily extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l4asessfamily);
        ...
        correctAnswer = new Dialog(basicL4asessfamily.this);
        ...
        betterLuck = new Dialog(basicL4asessfamily.this);
        ...
        wrongAnswer = new Dialog(basicL4asessfamily.this);
        ...
        congratsDialog = new Dialog(basicL4asessfamily.this);
        ...
        Loading = new Dialog(basicL4asessfamily.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1rmwbou1oeOGVGPJiRQk7oxkGhHXAE2ey"), //Auntie
                Uri.parse("https://drive.google.com/uc?export=download&id=1GzOC4PBfeKzA4noWixFqAWsrq61morRL"), //brother in law
                Uri.parse("https://drive.google.com/uc?export=download&id=1TFUFGwm4xUow3QcEfF3ZsuOCuyYZYA20"), //cousin
                Uri.parse("https://drive.google.com/uc?export=download&id=1d3IcJ0cYhpjBS1Wv4piROqD6icTjeLF8"), //grandfather
                Uri.parse("https://drive.google.com/uc?export=download&id=1QR1QGQT0gOqSzalifSooW33ZKxXj9hUN"), //nephew
                Uri.parse("https://drive.google.com/uc?export=download&id=1WwVF_VoPr6jtSsTsAfu7G1OiFIJhGXwx"), //neice
                Uri.parse("https://drive.google.com/uc?export=download&id=1tL2PGpKOItDgNFc_BwOUK5MgXICxEMbU"), //sister in law
                Uri.parse("https://drive.google.com/uc?export=download&id=1O68D7gU3Y5WE7VT5OJ0uz4KKcbmrXC4s"), //step brother
                Uri.parse("https://drive.google.com/uc?export=download&id=1__V6r-fRhc6-ziIWadywx3J1Zm5ZNTqX"), //step mother
                Uri.parse("https://drive.google.com/uc?export=download&id=1sWH4OIKYwhKVhbYG0JnaMnoGfDqwYA5H"), //Step sister
                // Add more URIs as needed
        };

        answers = new String[]{"Auntie", "Brother in law", "Cousin", "Grandfather", "Nephew", "Neice",
                "Sister in law", "Step Brother", "Step mother", "Step sister"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL4asessfamily.this, b4family.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("family").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("family");
                        DatabaseReference checknumberScore = usersRef.child("familyscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL4asessfamily.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("familyscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("familyscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

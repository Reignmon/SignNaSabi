...
public class basicL4asessrelation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l4asessrelation);
        ...
        correctAnswer = new Dialog(basicL4asessrelation.this);
        ...
        betterLuck = new Dialog(basicL4asessrelation.this);
        ...
        wrongAnswer = new Dialog(basicL4asessrelation.this);
        ...
        congratsDialog = new Dialog(basicL4asessrelation.this);
        ...
        Loading = new Dialog(basicL4asessrelation.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1vkiVtp2iX7clmjYfFAfQtmd6N9lEZSvp"), //wife
                Uri.parse("https://drive.google.com/uc?export=download&id=1gY1Hxvv1-zDN-m5I59swEaTSWiWUDNnp"), //together
                Uri.parse("https://drive.google.com/uc?export=download&id=1tjUCGbK4fkIQ-uUZ4uTGJYdpKK1T-phr"), //partner
                Uri.parse("https://drive.google.com/uc?export=download&id=1cEY7HXQ1ORvfKHtBRXjqAVbwczCk-BLV"), //married
                Uri.parse("https://drive.google.com/uc?export=download&id=1ResGrRvGlcHgNqGOJ5ZLm9AiKzNkVCG6"), //husband
                Uri.parse("https://drive.google.com/uc?export=download&id=1XN25wdlxyb8gfcs_CIGADCjg1rrNT1ce"), //girlfreind
                Uri.parse("https://drive.google.com/uc?export=download&id=1p5VzHuIXckxRAF_GtcHGPUxEo9CCfQed"), //freind
                Uri.parse("https://drive.google.com/uc?export=download&id=14TIXNn3FY9IhZ31Sl6D7bkymGK9xat5i"), //fallinove
                Uri.parse("https://drive.google.com/uc?export=download&id=1HdJu470dZ43XSltBBLl4TYmTvCCQ8gpg"), //date
                Uri.parse("https://drive.google.com/uc?export=download&id=1V1rg2pUbaIe9b3AEKzMyCuJt9h2uHAPj"), //boyfreind
                // Add more URIs as needed
        };

        answers = new String[]{"Wife", "Together", "Partner", "Married", "Husband", "Girlfriend",
                "Friend", "Fall in love", "Date", "Boyfriend"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL4asessrelation.this, b4relationship.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("relationship").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("relationship");
                        DatabaseReference checknumberScore = usersRef.child("relationshipscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL4asessrelation.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("relationshipscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("relationshipscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

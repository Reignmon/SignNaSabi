...
public class basicL4assespeople extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l4assespeople);
        ...
        correctAnswer = new Dialog(basicL4assespeople.this);
        ...
        betterLuck = new Dialog(basicL4assespeople.this);
        ...
        wrongAnswer = new Dialog(basicL4assespeople.this);
        ...
        congratsDialog = new Dialog(basicL4assespeople.this);
        ...
        Loading = new Dialog(basicL4assespeople.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1JLnjy5B9iCmOmOWxF2IX_oKE1lL1__da"), //scientist
                Uri.parse("https://drive.google.com/uc?export=download&id=1q4J_ZlZht9xY7xr2Rx97qNIcpbbjYKdp"), //principal
                Uri.parse("https://drive.google.com/uc?export=download&id=1KOAhAZQK0rD9NSqz9BQlwiG1Zlb6SgsZ"), //pilot
                Uri.parse("https://drive.google.com/uc?export=download&id=1y6hMQtB7_Z2Rarwd3svhVRmdowEHWrY6"), //nurse
                Uri.parse("https://drive.google.com/uc?export=download&id=1JCqm44H9OzpEqZvMsYSKNGDbLkAKF78Z"), //lawyer
                Uri.parse("https://drive.google.com/uc?export=download&id=1xbHQq05tMZ_sfotk8LHW4mwhyNxC8GGf"), //farmer
                Uri.parse("https://drive.google.com/uc?export=download&id=1pmT1hJT3vwbcjiJavq505vKzu3fhEQQg"), //entreprenuer
                Uri.parse("https://drive.google.com/uc?export=download&id=17sEzWfYN-8br2ISaDkhjZfAHTOnUJ2Ce"), //engineer
                Uri.parse("https://drive.google.com/uc?export=download&id=1GeQaBTXQdy087nUdLUhcxO6viuyQo1o3"), //chef
                Uri.parse("https://drive.google.com/uc?export=download&id=1zO0KdlSsKP39_inZmqS5vQlfhFe-_hqH"), //athlete
                // Add more URIs as needed
        };

        answers = new String[]{"Scientist", "Principal", "Pilot", "Nurse", "Lawyer", "Farmer",
                "Entreprenuer", "Engineer", "Chef", "Athlete"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL4assespeople.this, b4people.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("people").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("people");
                        DatabaseReference checknumberScore = usersRef.child("peoplescore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL4assespeople.this, basiclevel.class));
                                    finish();
                                }else{
                                    lessonaslRef.setValue(0);
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL4assespeople.this, b2greetings.class));
                                    finish();
                                }
                            }
                            @Override
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("peoplescore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("peoplescore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

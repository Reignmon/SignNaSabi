...
public class basicL5asessadjective extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l5asessadjective);
        ...
        correctAnswer = new Dialog(basicL5asessadjective.this);
        ...
        betterLuck = new Dialog(basicL5asessadjective.this);
        ...
        wrongAnswer = new Dialog(basicL5asessadjective.this);
        ...
        congratsDialog = new Dialog(basicL5asessadjective.this);
        ...
        Loading = new Dialog(basicL5asessadjective.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1-o4BQrBIVrknOffUAHGwziFmb2VBwWs8"), //clean
                Uri.parse("https://drive.google.com/uc?export=download&id=1YAJu8JtaDwx6bV2KpfwFQnD9atqTJu31"), //close
                Uri.parse("https://drive.google.com/uc?export=download&id=1ZnXXh3jWawgZlbqof9nRvvP8k9HOpRxo"), //dim
                Uri.parse("https://drive.google.com/uc?export=download&id=1FuHFaqm7aEKS2UNddbAnL0k7w7DIeAap"), //dirty
                Uri.parse("https://drive.google.com/uc?export=download&id=1PcVUgvdWyZ8FzmjIp3dzndodd03Mjakg"), //far
                Uri.parse("https://drive.google.com/uc?export=download&id=1iuzKXRroRaFNPrfAYOcRUi5NA3cKixlT"), //funny
                Uri.parse("https://drive.google.com/uc?export=download&id=1pHuqtLomKSgY2NpiuLAkBE0IrCANScbr"), //high
                Uri.parse("https://drive.google.com/uc?export=download&id=1jbxB7bDRx9Z3u27uSw-XWU_e-Tqn5o1B"), //low
                Uri.parse("https://drive.google.com/uc?export=download&id=1TDVkTVULQePaO8EmUL7DK3QrbtDi8jCD"), //pretty
                Uri.parse("https://drive.google.com/uc?export=download&id=1Lwjdr46TC7TW4T4u6u0DRFaL7L7Cujx0"), //ugly
                // Add more URIs as needed
        };

        answers = new String[]{"Clean", "Close", "Dim", "Dirty", "Far", "Funny",
                "High", "Low", "Pretty", "Ugly"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL5asessadjective.this, b4adjective.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("adjective").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("adjective");
                        DatabaseReference checknumberScore = usersRef.child("adjectivescore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL5asessadjective.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("adjectivescore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("adjectivescore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

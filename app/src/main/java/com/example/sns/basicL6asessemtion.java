...
public class basicL6asessemtion extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l6asessemtion);
        ...
        correctAnswer = new Dialog(basicL6asessemtion.this);
        ...
        betterLuck = new Dialog(basicL6asessemtion.this);
        ...
        wrongAnswer = new Dialog(basicL6asessemtion.this);
        ...
        congratsDialog = new Dialog(basicL6asessemtion.this);
        ...
        Loading = new Dialog(basicL6asessemtion.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=11U7-gfNnZxAUl_sabaeAamW5qoV-XKg0"), //Tired
                Uri.parse("https://drive.google.com/uc?export=download&id=17TymFicikhIKCzXY-Fn6GXRGnazl8pu9"), //busy
                Uri.parse("https://drive.google.com/uc?export=download&id=18pa641JQc1hiQXny7uhvnGyFx5FOVFMU"), //emotional
                Uri.parse("https://drive.google.com/uc?export=download&id=1Lnpl8H4zoaaWxnArPgijj0dgg3jAyVt4"), //fine
                Uri.parse("https://drive.google.com/uc?export=download&id=1HR6UHCqPhj6f4XWz2PX-4WW9qq1gvwQd"), //frustrated
                Uri.parse("https://drive.google.com/uc?export=download&id=1KKVNSRI7xWiXyrB3t0eZ_m4dE9E7w-8c"), //mad or angry
                Uri.parse("https://drive.google.com/uc?export=download&id=1AC-TTytwm2K9wsCE7gLiR4aQFhpYsWrM"), //nervous
                Uri.parse("https://drive.google.com/uc?export=download&id=12_6aRJeC1Y2S_xmGLhMZxMzWZL27G9Z6"), //nothing
                Uri.parse("https://drive.google.com/uc?export=download&id=1gvqYQRGyCb29gFjq6p3UdHJUGa8d9CnZ"), //sick
                Uri.parse("https://drive.google.com/uc?export=download&id=1gyjqSjVJHMlhrZdpv58BnIq5Okzxxs6q"), //sleepy
                // Add more URIs as needed
        };

        answers = new String[]{"Tired", "Busy", "Emotional", "Fine", "Frustrated", "Mad or Angry",
                "Nervous", "Nothing", "Sick", "Sleepy"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL6asessemtion.this, b6emotion.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("emotions").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("emotions");
                        DatabaseReference checknumberScore = usersRef.child("emotionsscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL6asessemtion.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("emotionsscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("emotionsscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

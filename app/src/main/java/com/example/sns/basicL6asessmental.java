...
public class basicL6asessmental extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l6asessmental);
        ...
        correctAnswer = new Dialog(basicL6asessmental.this);
        ...
        betterLuck = new Dialog(basicL6asessmental.this);
        ...
        wrongAnswer = new Dialog(basicL6asessmental.this);
        ...
        congratsDialog = new Dialog(basicL6asessmental.this);
        ...
        Loading = new Dialog(basicL6asessmental.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=17FElMMxwTEhfkpUPVbG_k8o-3qD2dWi7"), //clever
                Uri.parse("https://drive.google.com/uc?export=download&id=1pK58tpEUwEd0ublrdUz6_lBIRunQeNzs"), //concept
                Uri.parse("https://drive.google.com/uc?export=download&id=1pK58tpEUwEd0ublrdUz6_lBIRunQeNzs"), //concern
                Uri.parse("https://drive.google.com/uc?export=download&id=1L1AxNDb-wHu56PSLAQ7O005ve0qU4pdE"), //hope
                Uri.parse("https://drive.google.com/uc?export=download&id=1hQCdQPiD0fXB0L2WoKBnuCPswMazMPTy"), //idea
                Uri.parse("https://drive.google.com/uc?export=download&id=1y3KqLzR4w6niueP9oyqWTk9KBi7shE1F"), //ignorant
                Uri.parse("https://drive.google.com/uc?export=download&id=1Aj-ojVXN-LTs2FIvQTc8pq1_j7GbY9j0"), //mean
                Uri.parse("https://drive.google.com/uc?export=download&id=1hrHjFhuYQnzwHjNJ5RW8i6xO0iC6Tn8c"), //opinion
                Uri.parse("https://drive.google.com/uc?export=download&id=1u758bZCLtzdKb_7FK_FWQBdyKoEHgWRX"), //reason
                Uri.parse("https://drive.google.com/uc?export=download&id=1Yon9JwQK7pxaEdS5Ea2Zbhyeck92Re3t"), //suppose
                // Add more URIs as needed
        };

        answers = new String[]{"Clever", "Concept", "Concern", "Hope", "Idea", "Ignorant",
                "Mean", "Opinion", "Reason", "Suppose"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL6asessmental.this, b6mentalact.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("mentalaction").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("mentalaction");
                        DatabaseReference checknumberScore = usersRef.child("mentalactionscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL6asessmental.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("mentalactionscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("mentalactionscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

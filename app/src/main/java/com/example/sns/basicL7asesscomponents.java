...
public class basicL7asesscomponents extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l7asesscomponents);
        ...
        correctAnswer = new Dialog(basicL7asesscomponents.this);
        ...
        betterLuck = new Dialog(basicL7asesscomponents.this);
        ...
        wrongAnswer = new Dialog(basicL7asesscomponents.this);
        ...
        congratsDialog = new Dialog(basicL7asesscomponents.this);
        ...
        Loading = new Dialog(basicL7asesscomponents.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=114D_A9m7xE8aN5htqox9TQ_auF9Fq18H"), //bathroom
                Uri.parse("https://drive.google.com/uc?export=download&id=1M50Z6ZYyGvwKmzsE3mTqM68RKygdTR9u"), //bed
                Uri.parse("https://drive.google.com/uc?export=download&id=1hmGbIgL767rR6fZlswREiNI3LycKsOoA"), //bedroom
                Uri.parse("https://drive.google.com/uc?export=download&id=1wSUSHGir1kPrjuS0QRmGK2DHQN7RCga7"), //chair
                Uri.parse("https://drive.google.com/uc?export=download&id=1CQg32kvUitr_buameyDP4Qd9gVKhX06e"), //light
                Uri.parse("https://drive.google.com/uc?export=download&id=1ODDnO6YN-h3drMiLLWLKEsbRlRiV0nzV"), //mirror
                Uri.parse("https://drive.google.com/uc?export=download&id=1Gx9I1iBez1m7zC3HRckBwab_P7rsgqJh"), //refrigirator
                Uri.parse("https://drive.google.com/uc?export=download&id=1oHL1L9m9kw1082fWlLno62_j9j_QAvRQ"), //sofa
                Uri.parse("https://drive.google.com/uc?export=download&id=1cDFz_NzDRabLKfOULThoGd5zvCkMG8po"), //table
                Uri.parse("https://drive.google.com/uc?export=download&id=1JOO3gNIqM8_ys3TlD4w8wFb-CA7YaozX"), //t.v
                // Add more URIs as needed
        };

        answers = new String[]{"Bathroom", "Bed", "Bedroom", "Chair", "Light", "Mirror", "Refrigerator", "Sofa", "Table",
                "T.V"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL7asesscomponents.this, b7areas.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("areas").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("areas");
                        DatabaseReference checknumberScore = usersRef.child("areasscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL7asesscomponents.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("areasscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("areasscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

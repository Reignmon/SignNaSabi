...
public class basicL7asessdirection extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l7asessdirection);
        ...
        correctAnswer = new Dialog(basicL7asessdirection.this);
        ...
        betterLuck = new Dialog(basicL7asessdirection.this);
        ...
        wrongAnswer = new Dialog(basicL7asessdirection.this);
        ...
        congratsDialog = new Dialog(basicL7asessdirection.this);
        ...
        Loading = new Dialog(basicL7asessdirection.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1AliQRllGf2xJbLtM6lUJS-fpyCYjI_Bp"), //below
                Uri.parse("https://drive.google.com/uc?export=download&id=1AliQRllGf2xJbLtM6lUJS-fpyCYjI_Bp"), //bottom
                Uri.parse("https://drive.google.com/uc?export=download&id=1Ris7_Vg3eQ7lYFP0C6BvO4SGfZe7CC9q"), //from
                Uri.parse("https://drive.google.com/uc?export=download&id=1FDznrrYpLVfpm6WnzwvOLcEVqD3CdlFb"), //horizontal
                Uri.parse("https://drive.google.com/uc?export=download&id=18DhwBi02eHJnoFD2zdmPztn-HNPRDlf0"), //in
                Uri.parse("https://drive.google.com/uc?export=download&id=1YvfPGMjMhH50OjiSZb_WQr8GMet5VTU1"), //off
                Uri.parse("https://drive.google.com/uc?export=download&id=1RXt3NYCWTHXv1R8HJNRcfxrRx_oHvYOx"), //out
                Uri.parse("https://drive.google.com/uc?export=download&id=1DUfClZG7DFHdqynzbIN2sag6hN9eHQ27"), //to
                Uri.parse("https://drive.google.com/uc?export=download&id=1AY6OWEA5UEVX070117Nu_x1pORbWBLGX"), //top
                Uri.parse("https://drive.google.com/uc?export=download&id=1DvsUpMEZjjbcU6R1JPehGPoQGC0yeWJ1"), //up
                // Add more URIs as needed
        };

        answers = new String[]{"Below", "Bottom", "From", "Horizontal", "In", "Off", "Out", "To", "Top",
                "Up"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL7asessdirection.this, b7placelocation.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("direction").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("direction");
                        DatabaseReference checknumberScore = usersRef.child("directionscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL7asessdirection.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("directionscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("directionscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

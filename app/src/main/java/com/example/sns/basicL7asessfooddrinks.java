...
public class basicL7asessfooddrinks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l7asessfooddrinks);
        ...
        correctAnswer = new Dialog(basicL7asessfooddrinks.this);
        ...
        betterLuck = new Dialog(basicL7asessfooddrinks.this);
        ...
        wrongAnswer = new Dialog(basicL7asessfooddrinks.this);
        ...
        congratsDialog = new Dialog(basicL7asessfooddrinks.this);
        ...
        Loading = new Dialog(basicL7asessfooddrinks.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1kMz-ZJ96HfOuf6Dz-XNGYx7WAtJGvwcN"), //candy
                Uri.parse("https://drive.google.com/uc?export=download&id=1MJhBx6bAHeot-RejGowPW7ojiV-cxh9n"), //coffe
                Uri.parse("https://drive.google.com/uc?export=download&id=1_ZsWBAHBT6vCPK_zDbR9yPVucZmYrHDb"), //french fries
                Uri.parse("https://drive.google.com/uc?export=download&id=1hPWjW-rHR2YW-mMhaiOV8z0mK3OVuNyE"), //fruits
                Uri.parse("https://drive.google.com/uc?export=download&id=1xS-OE9OzE83mUDw9OmH3RnlZu90hcMuU"), //humburger
                Uri.parse("https://drive.google.com/uc?export=download&id=1RCTcnRr2logueTpntItF6mrtPlWHBOXn"), //juice
                Uri.parse("https://drive.google.com/uc?export=download&id=1IxBOAsb61E-KL6dQmQkYSn3nw9ENyVyv"), //milk
                Uri.parse("https://drive.google.com/uc?export=download&id=1gZN6JlFKdOuLmRHOOGuXP5kzGbrIeAIW"), //pizza
                Uri.parse("https://drive.google.com/uc?export=download&id=1pxHfOWS6RLsTnYWj91fm0zjVv5P6QzUO"), //soda
                Uri.parse("https://drive.google.com/uc?export=download&id=1nIUjGhf9jz6DPAK5EtsRw_JvhOnG_ymf"), //tea
                // Add more URIs as needed
        };

        answers = new String[]{"Candy", "Coffe", "French fries", "Fruits", "Humburger", "Juice", "Milk", "Pizza", "Soda",
                "Tea"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL7asessfooddrinks.this, b7foodsdrinks.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("refreshment").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("refreshment");
                        DatabaseReference checknumberScore = usersRef.child("refreshmentscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL7asessfooddrinks.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("refreshmentscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("refreshmentscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

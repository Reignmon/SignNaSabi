...
public class basicL8asessbodypart extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l8asessbodypart);
        ...
        correctAnswer = new Dialog(basicL8asessbodypart.this);
        ...
        betterLuck = new Dialog(basicL8asessbodypart.this);
        ...
        wrongAnswer = new Dialog(basicL8asessbodypart.this);
        ...
        congratsDialog = new Dialog(basicL8asessbodypart.this);
        ...
        Loading = new Dialog(basicL8asessbodypart.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1HbLy_vYrHoTAFENLSVxzMobsssLRIo2h"), //arm
                Uri.parse("https://drive.google.com/uc?export=download&id=1_j_TqwQS6YMJCtstlFtYpRy_kZjLYHwS"), //back
                Uri.parse("https://drive.google.com/uc?export=download&id=16PgFX1V55ZTxYWifQlKu2ACYQTZ0-sSd"), //ear
                Uri.parse("https://drive.google.com/uc?export=download&id=1Z-5r4JwljD3DsE2cYQIRthEEmslBqJ5v"), //eyes
                Uri.parse("https://drive.google.com/uc?export=download&id=12W4NJHUGkgURW6QvHBvSIpNRDdTBBGHm"), //face
                Uri.parse("https://drive.google.com/uc?export=download&id=1j-eITWS6L7KJAzROQjUuThW0xu77ArIn"), //foot
                Uri.parse("https://drive.google.com/uc?export=download&id=1_71AgpRbkrV7e5Dy-h-OiejyLQ33vVRA"), //hair
                Uri.parse("https://drive.google.com/uc?export=download&id=1baruVMw7WSBSMoiteu7mvwdp7aYlxaYv"), //hand
                Uri.parse("https://drive.google.com/uc?export=download&id=1uQKRds-TvXbtl-Whscf7JUZl2ox6-Ajb"), //head
                Uri.parse("https://drive.google.com/uc?export=download&id=1WDO_bGUqV0SFesgiDIejwA49VGg80d_u"), //mouth
                // Add more URIs as needed
        };

        answers = new String[]{"Arm", "Back", "Ear", "Eyes", "Face", "Foot", "Hair", "Hand", "Head",
                "Mouth"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL8asessbodypart.this, b8bodypart.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("bodyparts").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("bodyparts");
                        DatabaseReference checknumberScore = usersRef.child("bodypartsscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL8asessbodypart.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("bodypartsscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("bodypartsscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

...
public class basicL8asessclothes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_basic_l8asessclothes);
        ...
        correctAnswer = new Dialog(basicL8asessclothes.this);
        ...
        betterLuck = new Dialog(basicL8asessclothes.this);
        ...
        wrongAnswer = new Dialog(basicL8asessclothes.this);
        ...
        congratsDialog = new Dialog(basicL8asessclothes.this);
        ...
        Loading = new Dialog(basicL8asessclothes.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1bki53YgQ1g_z9KjJGaEKnKb49jXNOCM6"), //brush your teeth
                Uri.parse("https://drive.google.com/uc?export=download&id=1kFdKTcx5k-T5VWTnQ-9ZX3zYjrg5UYoT"), //dress
                Uri.parse("https://drive.google.com/uc?export=download&id=13dfoX4X-qxTIzQwshtw3UC10wbCG1jNs"), //jacket
                Uri.parse("https://drive.google.com/uc?export=download&id=1YOWUIJBW_pOLQST9JKYK2YRAh-Z-63l3"), //jeans
                Uri.parse("https://drive.google.com/uc?export=download&id=1V68hOh8mbT-KbqSrPOE-4VlsjOgZNdRp"), //pants
                Uri.parse("https://drive.google.com/uc?export=download&id=1NCxMrXpl7S0wAMjEmJvDDOVECWIhkKo3"), //shirts
                Uri.parse("https://drive.google.com/uc?export=download&id=1SUkUhOzvKjrW3nwzRdv_9nJre5maJ3--"), //short
                Uri.parse("https://drive.google.com/uc?export=download&id=1dGhps91pYMw0sfPpeencg1qYBrRSWBxf"), //shower
                Uri.parse("https://drive.google.com/uc?export=download&id=1sYDcuj5ec0y5U3XG2smCbn5jmyd8nPhb"), //trim your nails
                Uri.parse("https://drive.google.com/uc?export=download&id=1-xOX9qv5PDBmjHZW2edEqM85_Yho2cEg"), //wash your teeth
                // Add more URIs as needed
        };

        answers = new String[]{"Brush your teeth", "Dress", "Jacket", "Jeans", "Pants", "Shirts", "Shorts", "Shower", "Trim your nails",
                "Wash your hands"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(basicL8asessclothes.this, b8clothehygiene.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("clothes").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("clothes");
                        DatabaseReference checknumberScore = usersRef.child("clothesscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(basicL8asessclothes.this, basiclevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("clothesscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("clothesscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

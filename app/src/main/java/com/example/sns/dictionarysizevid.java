...
public class dictionarysizevid extends AppCompatActivity {
    int getvalue;
    TextView btnBack;
    VideoView videoView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dictionarysizevid);
        ...
        btnBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(dictionarysizevid.this, dictionarysize.class));
                finish();
            }
        });

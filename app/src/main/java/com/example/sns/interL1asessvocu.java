...
public class interL1asessvocu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l1asessvocu);
        ...
        correctAnswer = new Dialog(interL1asessvocu.this);
        ...
        betterLuck = new Dialog(interL1asessvocu.this);
        ...
        wrongAnswer = new Dialog(interL1asessvocu.this);
        ...
        congratsDialog = new Dialog(interL1asessvocu.this);
        ...
        Loading = new Dialog(interL1asessvocu.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1meEDuGgKMoDJJpG9dFk3UbZ8Ul099yC-"), //Again
                Uri.parse("https://drive.google.com/uc?export=download&id=1H2xTObsWH_QYOv1esYbhc9HGUsGLeBZ-"), //Find
                Uri.parse("https://drive.google.com/uc?export=download&id=1V053ZXThrgZETtACk9ff_Tjqzm__Vx0u"), //Fine
                Uri.parse("https://drive.google.com/uc?export=download&id=1eCO0D5ceJ-sBIk68TCxBncB76KcImP8i"), //Finish
                Uri.parse("https://drive.google.com/uc?export=download&id=15hyiOsyLciUQ6IGyoC56D4hvF7wf2V3P"), //Go out
                Uri.parse("https://drive.google.com/uc?export=download&id=1YoCPyYBcvYHdX5yzdZPYm3vApyoedFmS"), //Learn
                Uri.parse("https://drive.google.com/uc?export=download&id=1K_RJPxDp4EAsnEtDuB3YRoAb3qjFau8x"), //Like
                Uri.parse("https://drive.google.com/uc?export=download&id=1wQWHsEfDFL4TVdiJtaZmQES6_6SEakaF"), //Milk
                Uri.parse("https://drive.google.com/uc?export=download&id=1oF_WNBWMalZ4n5s4nquOmyc0QEJI-d6D"), //More
                Uri.parse("https://drive.google.com/uc?export=download&id=1JJk_J-kE-hyfMQKCLrpPoQHIdd3G_tD3"), //Need
                Uri.parse("https://drive.google.com/uc?export=download&id=1fCofr-h3TvVT2ddSKFBTk_v5VK1VkZ8f"), //Sign
                Uri.parse("https://drive.google.com/uc?export=download&id=1sb_4rSOje-Tk1SUJ0eriiXszGHKg-wBl"), //What
                // Add more URIs as needed
        };

        answers = new String[]{"Again", "Find", "Fine", "Finish", "Go out", "Learn", "Like", "Milk", "More",
                "Need","Sign","What"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(interL1asessvocu.this, interL1vocubulary.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("vocubulary").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("vocubulary");
                        DatabaseReference checknumberScore = usersRef.child("vocubularyscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL1asessvocu.this, intermediatelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("vocubularyscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("vocubularyscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

...
public class interL2asessatt extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l2asessatt);
        ...
        correctAnswer = new Dialog(interL2asessatt.this);
        ...
        betterLuck = new Dialog(interL2asessatt.this);
        ...
        wrongAnswer = new Dialog(interL2asessatt.this);
        ...
        congratsDialog = new Dialog(interL2asessatt.this);
        ...
        Loading = new Dialog(interL2asessatt.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1VCtwDmSOxX_0Kj8YcQpJ_P9ZFtV5PbtD"), //Anxious
                Uri.parse("https://drive.google.com/uc?export=download&id=1r39jyvHLRixgXeDmQHWYorY2dTU7fwu4"), //Apprehensive
                Uri.parse("https://drive.google.com/uc?export=download&id=1J_RUaq3GRmF8cuedMwg4Yj_8F6TfyEp9"), //Confident
                Uri.parse("https://drive.google.com/uc?export=download&id=1F7Wx65X2NLk4kmvzUbWtDi5uPTlNQWdq"), //Cynical
                Uri.parse("https://drive.google.com/uc?export=download&id=1Y63lG6Xr60aX7xOVoROyTO8AL1khPh9l"), //Enthusiastic
                Uri.parse("https://drive.google.com/uc?export=download&id=1UIRVS__C1OD5IexKoyoB0uEYQ2tlphpP"), //Hopeful
                Uri.parse("https://drive.google.com/uc?export=download&id=1XU776b_iIE1VefaKDyNM1XC9PWSx5qO1"), //Indefferent
                Uri.parse("https://drive.google.com/uc?export=download&id=1EAzNRCKme9Kgx9QROxHYnUVMh6oqh6lh"), //Optimistic
                Uri.parse("https://drive.google.com/uc?export=download&id=1yjwWRo9IZlnAlR7qj9NzTWMDkz2904Ma"), //Pessimistic
                // Add more URIs as needed
        };

        answers = new String[]{"Anxious", "Apprehensive", "Confident", "Cynical", "Enthusiastic", "Hopeful", "Indefferent", "Optimistic", "Pessimistic"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(interL2asessatt.this, interL2attitudes.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("attitudes").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("attitudes");
                        DatabaseReference checknumberScore = usersRef.child("attitudesscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL2asessatt.this, intermediatelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("attitudesscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("attitudesscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

...
public class interL2asesscharac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l2asesscharac);
        ...
        correctAnswer = new Dialog(interL2asesscharac.this);
        ...
        betterLuck = new Dialog(interL2asesscharac.this);
        ...
        wrongAnswer = new Dialog(interL2asesscharac.this);
        ...
        congratsDialog = new Dialog(interL2asesscharac.this);
        ...
        Loading = new Dialog(interL2asesscharac.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1d9vhqwvPhQdxI-5l11gZ8asTV1yQaNV1"), //Reliable
                Uri.parse("https://drive.google.com/uc?export=download&id=1BEF5sKkkVvfsd0Z-V6DxG6WVQXB8jbtl"), //Patient
                Uri.parse("https://drive.google.com/uc?export=download&id=1-GXltTX5isOW76wa9zhaybUv6v7f8ltr"), //Honest
                Uri.parse("https://drive.google.com/uc?export=download&id=1ceTw2jvGsURIRVeW4cqCOYOdKcDZATor"), //Generous
                Uri.parse("https://drive.google.com/uc?export=download&id=1ORq5Y4TAIi1mxSkRAWWMr69VNfTK8bZR"), //Friendly
                Uri.parse("https://drive.google.com/uc?export=download&id=1444h59aapUQsrbEaBitLLY1LEZDhGDH6"), //Diligent
                Uri.parse("https://drive.google.com/uc?export=download&id=1POg8bJRzQYMwR4nNuVOdM5rGv0XpxGzs"), //Curios
                Uri.parse("https://drive.google.com/uc?export=download&id=1NWMuSDVqxcXLTRe0VuFQqwR28OnIRSYb"), //Creative
                Uri.parse("https://drive.google.com/uc?export=download&id=1GO9BXbLcoobA-ftE46wYFR-EQIDUCj6o"), //Confident
                Uri.parse("https://drive.google.com/uc?export=download&id=1DBbINRiQcTr84LyZKb6JRBC3wBkeWHA6"), //Ambitious
                // Add more URIs as needed
        };

        answers = new String[]{"Reliable", "Patient", "Honest", "Generous", "Friendly", "Diligent", "Curios", "Creative", "Confident",
                "Ambitious"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(interL2asesscharac.this, interL2charac.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("characteristics").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("characteristics");
                        DatabaseReference checknumberScore = usersRef.child("characteristicsscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL2asesscharac.this, intermediatelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("characteristicsscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("characteristicsscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

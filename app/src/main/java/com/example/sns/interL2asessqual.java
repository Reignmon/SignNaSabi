...
public class interL2asessqual extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l2asessqual);
        ...
        correctAnswer = new Dialog(interL2asessqual.this);
        ...
        betterLuck = new Dialog(interL2asessqual.this);
        ...
        wrongAnswer = new Dialog(interL2asessqual.this);
        ...
        congratsDialog = new Dialog(interL2asessqual.this);
        ...
        Loading = new Dialog(interL2asessqual.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1Ud_0ptiiz8A8Hg_Xf1VEx12oB4v5wZwZ"), //Strong
                Uri.parse("https://drive.google.com/uc?export=download&id=1sGmGc9kabOdCmFITERzmG5QfkzpXZnSv"), //Innovative
                Uri.parse("https://drive.google.com/uc?export=download&id=1n40ddWDAJquFY8zB3FySC1A8E9uDcSus"), //Gentle
                Uri.parse("https://drive.google.com/uc?export=download&id=1DBlDzK6MeVHJF5kaxhZGz810YPNKCbrZ"), //Friendly
                Uri.parse("https://drive.google.com/uc?export=download&id=1ki0CmGh67IjtyzaQ1zzShcWI9LLtE3uw"), //Elegant
                Uri.parse("https://drive.google.com/uc?export=download&id=1FJBQCQcVmcCOqTOCrWKjNtPlxlUrppbD"), //Efficient
                Uri.parse("https://drive.google.com/uc?export=download&id=1ZRvGvE7fNxmJmAU7p87_8-dUwEJ8QDyy"), //Delicious
                Uri.parse("https://drive.google.com/uc?export=download&id=1r9uQL7-p39MVDhMEiu3j19inIzWUfyMM"), //Brilliant
                Uri.parse("https://drive.google.com/uc?export=download&id=1c4drqAVYCxSNZkWSKh57-IW0y2JexHBv"), //Beautiful
                // Add more URIs as needed
        };

        answers = new String[]{"Strong", "Innovative", "Gentle", "Friendly", "Elegant", "Efficient", "Delicious", "Brilliant", "Beautiful"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(interL2asessqual.this, interL2quality.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("quality").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("quality");
                        DatabaseReference checknumberScore = usersRef.child("qualityscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL2asessqual.this, intermediatelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("qualityscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("qualityscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

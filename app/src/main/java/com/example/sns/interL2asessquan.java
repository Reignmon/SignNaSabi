...
public class interL2asessquan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l2asessquan);
        ...
        correctAnswer = new Dialog(interL2asessquan.this);
        ...
        betterLuck = new Dialog(interL2asessquan.this);
        ...
        wrongAnswer = new Dialog(interL2asessquan.this);
        ...
        congratsDialog = new Dialog(interL2asessquan.this);
        ...
        Loading = new Dialog(interL2asessquan.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1Ucqlub_Euoafa-6MM0c6hZI2A_rhMoVt"), //Whole
                Uri.parse("https://drive.google.com/uc?export=download&id=1tGjBe50BLYBfuU4g-eKQv39z86ZsYCOD"), //Some
                Uri.parse("https://drive.google.com/uc?export=download&id=1OPutNrGbJfkKHrmsnpTouIG5N9AR0y0G"), //Several
                Uri.parse("https://drive.google.com/uc?export=download&id=1BKfg25FT-uZ_ksTw74yXP_0I4oFtMt_J"), //Many
                Uri.parse("https://drive.google.com/uc?export=download&id=1WjQq__wO9Nqph5GiBBmGMEYvQuCC9LkQ"), //Few
                Uri.parse("https://drive.google.com/uc?export=download&id=1ncWQxxAAE6unes2BRS_i3rhkVyqE1Qi0"), //Enough
                Uri.parse("https://drive.google.com/uc?export=download&id=1DD93O0Hicw3CYStBtZM9WmnHdCAk6HNk"), //Dozen
                Uri.parse("https://drive.google.com/uc?export=download&id=17gxEn-ZX1JQm21oXtcBZEkJ7w885o5-D"), //All
                // Add more URIs as needed
        };

        answers = new String[]{"Whole", "Some", "Several", "Many", "Few", "Enough", "Dozen", "All"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(interL2asessquan.this, itnerL2quantity.class));
            finish();
        });
            ...
            public void onClick(View view) {
                ...
                usersRef.child("quantity").addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("quantity");
                        DatabaseReference checknumberScore = usersRef.child("quantityscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL2asessquan.this, intermediatelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("quantityscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("quantityscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

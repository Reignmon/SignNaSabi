...
public class interL3asessact extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l3asessact);
        ...
        correctAnswer = new Dialog(interL3asessact.this);
        ...
        betterLuck = new Dialog(interL3asessact.this);
        ...
        wrongAnswer = new Dialog(interL3asessact.this);
        ...
        congratsDialog = new Dialog(interL3asessact.this);
        ...
        Loading = new Dialog(interL3asessact.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=17FLsNzg3bFNkUJ1hn8Ez07kjMpPjVCXN"), //Bow
                Uri.parse("https://drive.google.com/uc?export=download&id=1elrdOS0SowapZ5BgGevXmMhdkO2sReOy"), //Buy
                Uri.parse("https://drive.google.com/uc?export=download&id=1n2pq6wyKXIyRfDSEMM-cG_oFMklBL_q-"), //Dream
                Uri.parse("https://drive.google.com/uc?export=download&id=1ciUK-6Jy50P8KIB05AZepr1KVfQqDyCC"), //Kick
                Uri.parse("https://drive.google.com/uc?export=download&id=1ccC_mdrzpcQDB2dqnA3-vIzPlVyGbl-t"), //Open
                Uri.parse("https://drive.google.com/uc?export=download&id=1AvUbnn6e3OAqwtWM03HlZaCFnO-3vl9z"), //Push
                Uri.parse("https://drive.google.com/uc?export=download&id=1ZdFb0bBEE3Hwk9opUoiZWBLOWQDnXlcz"), //Shake
                Uri.parse("https://drive.google.com/uc?export=download&id=1ZF3GpZn9BykcOUWcad7TTy08SdHs8HCH"), //Sleep
                Uri.parse("https://drive.google.com/uc?export=download&id=1f8qA4LRWQjofApENYvqUQ9-uO6vJIIPB"), //Smile
                Uri.parse("https://drive.google.com/uc?export=download&id=1xfQbvAoraueU2bsuSmmgJlwUfI78XvdG"), //Study
                // Add more URIs as needed
        };

        answers = new String[]{"Bow", "Buy", "Dream", "Kick", "Open", "Push", "Shake", "Sleep", "Smile",
                "Study"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(interL3asessact.this, interL3actionword.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("actword").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("actword");
                        DatabaseReference checknumberScore = usersRef.child("actwordscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL3asessact.this, intermediatelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("actwordscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("actwordscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

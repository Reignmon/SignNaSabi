...
public class interL6asessfood extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l6asessfood);
        ...
        correctAnswer = new Dialog(interL6asessfood.this);
        ...
        betterLuck = new Dialog(interL6asessfood.this);
        ...
        wrongAnswer = new Dialog(interL6asessfood.this);
        ...
        congratsDialog = new Dialog(interL6asessfood.this);
        ...
        Loading = new Dialog(interL6asessfood.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1U-kyGnCfLcqayW3dA-_x0HWu69Gz5c-z"), //Apple
                Uri.parse("https://drive.google.com/uc?export=download&id=1ZbI5y1bFAfuvs-pcXW6dVyWmBJ1udrR-"), //Banana
                Uri.parse("https://drive.google.com/uc?export=download&id=1L2bTbPuodvIQ3mFykNldYu-dRcuEiGRz"), //Chicken
                Uri.parse("https://drive.google.com/uc?export=download&id=1z7CcSEzFVVAnX7gBQT4vVKJXsrvJQa15"), //Egg
                Uri.parse("https://drive.google.com/uc?export=download&id=14bvDtrohLvMOiwlkncZ9GAwro3h24M0L"), //Hamburger
                Uri.parse("https://drive.google.com/uc?export=download&id=1mdcCic3rbVve3FRRg88XMt7J7USM9-yH"), //Hatdog
                Uri.parse("https://drive.google.com/uc?export=download&id=1iYrD_1TfZsgy0gUHwSwLfTi2sfUnT24Y"), //Meat
                Uri.parse("https://drive.google.com/uc?export=download&id=1GWtPgOxhqUzS9qj6Kw8L9S3xblosu-jg"), //Pizza
                Uri.parse("https://drive.google.com/uc?export=download&id=1ycoWjUC3CfCN_NAey1lVU3PkwaLB_nd_"), //Soup
                Uri.parse("https://drive.google.com/uc?export=download&id=1wUSQD_4lpQO-P4oQVKc3JFQr0jMIZXsR"), //Spaghetti
                //
        };

        answers = new String[]{"Apple", "Banana", "Chicken", "Egg", "Hamburger", "Hatdog", "Meat", "Pizza", "Soup",
                "Spaghetti"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(interL6asessfood.this, interL6foods.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("foods").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("foods");
                        DatabaseReference checknumberScore = usersRef.child("foodsscore");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL6asessfood.this, intermediatelevel.class));
                                    finish();
                                }else{
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("foodsscore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("foodsscore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();

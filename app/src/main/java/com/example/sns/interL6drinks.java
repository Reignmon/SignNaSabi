...
public class interL6drinks extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l6drinks);
        ...
        Loading = new Dialog(interL6drinks.this);
...
//end of code for backpress
            ...
            databaseReference.child("users").addListenerForSingleValueEvent(new ValueEventListener() {
                ...
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                    if(snapshot.hasChild(encodedEmail)){
                        usersRef.child("drinks").setValue(currentIndex);
                    }
                }
                @Override
    ...
    private void retrieveCurrentIndexFromFirebase() {
        String encodedEmail = encodeEmail(name);
        DatabaseReference usersRef = databaseReference.child("intermediatelevel_tb").child(encodedEmail).child("drinks");

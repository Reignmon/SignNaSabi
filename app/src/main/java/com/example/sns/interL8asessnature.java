...
public class interL8asessnature extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_inter_l8asessnature);
        ...
        correctAnswer = new Dialog(interL8asessnature.this);
        ...
        betterLuck = new Dialog(interL8asessnature.this);
        ...
        wrongAnswer = new Dialog(interL8asessnature.this);
        ...
        congratsDialog = new Dialog(interL8asessnature.this);
        ...
        Loading = new Dialog(interL8asessnature.this);
        ...
        videoUris = new Uri[]{
                Uri.parse("https://drive.google.com/uc?export=download&id=1Y8_58izJ3SlIONBmBaey86ggqrHpzZso"), //Canyon
                Uri.parse("https://drive.google.com/uc?export=download&id=1W98QQFDaVPN1Jsh-ihVtR7x56m6ISYLE"), //Dessert
                Uri.parse("https://drive.google.com/uc?export=download&id=1O1H0qHvPdM98IS6LgwVNH4lHUneT00cH"), //Earth
                Uri.parse("https://drive.google.com/uc?export=download&id=1Y3whQX33aoFlvq44nsJFU0u2UnAokl50"), //Forest
                Uri.parse("https://drive.google.com/uc?export=download&id=1M6KciJn2S38CeBbJayRKSm89reAEJ4Rw"), //jungle
                Uri.parse("https://drive.google.com/uc?export=download&id=1wPJneMYv865YeIwvKfb0N_qjUhcOPW3V"), //Lake
                Uri.parse("https://drive.google.com/uc?export=download&id=1d5rx_K-gQ3MxdxZ-jhUHPNThuEaJaBku"), //Mountain
                Uri.parse("https://drive.google.com/uc?export=download&id=14jwTtWdWEymOBLjESdVQgy8hyneSKJFy"), //Ocean
                Uri.parse("https://drive.google.com/uc?export=download&id=1rVqSildd1hxsnI2SXhm6p920NC6Fa163"), //Plain
                Uri.parse("https://drive.google.com/uc?export=download&id=1LHIV3q2U-rVGJH9v6A-ZurK3Y9N2w452"), //Tree
                // Add more URIs as needed
        };

        answers = new String[]{"Canyon", "Dessert", "Earth", "Forest", "Jungle", "Lake", "Mountain", "Ocean", "Plain","Tree"};
        ...
        btnback.setOnClickListener(view -> {
            startActivity(new Intent(interL8asessnature.this, interL7place.class));
            finish();
        });
        ...
        btnbetter.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                usersRef.child("nature").addListenerForSingleValueEvent(new ValueEventListener() {
                    @Override
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        DatabaseReference lessonaslRef = usersRef.child("nature");
                        DatabaseReference checknumberScore = usersRef.child("c");
                        checknumberScore.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot snapshot) {
                                if (snapshot.exists()){
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL8asessnature.this, intermediatelevel.class));
                                    finish();
                                }else{
                                    lessonaslRef.setValue(0);
                                    betterLuck.dismiss();
                                    Loading.dismiss();
                                    startActivity(new Intent(interL8asessnature.this, interL8nature.class));
                                    finish();
                                }
                            }
                            @Override
    ...
    private void addScore(Runnable onComplete) {
        ...
        usersRef.child("naturescore").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    usersRef.child("naturescore").setValue(correctScore).addOnCompleteListener(task -> {
                        Loading.dismiss();
